...
var Coord = /* #__PURE__ */ (function () {
    function Coord(value0, value1, value2) {
        this.value0 = value0;
        this.value1 = value1;
        this.value2 = value2;
    };
    Coord.create = function (value0) {
        return function (value1) {
            return function (value2) {
                return new Coord(value0, value1, value2);
            };
        };
    };
    return Coord;
        ...
        return function (first) {
            return function (o1) {
                return function (last$prime) {
                    ...
                    var last = (function () {
                        var $11 = Data_Eq.eq(Data_List_Lazy_Types.eqList(Data_Eq.eqNumber))(last$prime)(toL(Data_Foldable.foldableArray)([  ]));
                        if ($11) {
...
var twoPatternW = function (indexPhrase) {
    return function (first) {
        return function (last$prime) {
            var last = (function () {
                var $12 = Data_Eq.eq(Data_List_Lazy_Types.eqList(Data_Eq.eqNumber))(last$prime)(toL(Data_Foldable.foldableArray)([  ]));
                if ($12) {
                    return toL(Data_Foldable.foldableArray)([  ]);
                };
                return Data_Functor.map(Data_List_Lazy_Types.functorList)(function (v) {
...
var fromPatternToList = function (v) {
    if (v instanceof Rhythmic.Onsets) {
        return v.value0;
    };
...
var fromRhythmicToList = function (v) {
    ...
    if (v instanceof Rhythmic.Pattern) {
        return Data_List_Lazy.concat(Data_Functor.map(Data_List_Lazy_Types.functorList)(fromPatternToList)(v.value0));
    };
    return Data_List_Lazy.fromFoldable(Data_Foldable.foldableArray)([ false ]);
};
...
var positionToTime = function (t1) {
    return function (lenPasaje) {
        return function (v) {
            ...
            return new Coord(Data_Newtype.unwrap()(Data_DateTime_Instant.unInstant(Data_DateTime_Instant.fromDateTime(countInTime))) * 1000.0, floor(v.value0), v.value1);
        };
    };
};
        ...
        return function (ws1) {
            return function (we1) {
                return function (eval1) {
                    ...
                    var onsets = Data_Functor.map(Data_List_Lazy_Types.functorList)(function ($37) {
                        return Data_Rational.fromInt(Data_Tuple.snd($37));
                    })(Data_List_Lazy.filter(function (x1) {
                        return Data_Tuple.fst(x1) === true;
                    })(Data_List_Lazy.zip(x)(Data_List_Lazy.range(0)(Data_List_Lazy.length(x)))));
                    var oPercen = Data_Functor.map(Data_List_Lazy_Types.functorList)(function ($38) {
...
var coordenadaShowInstance = {
    show: function (v) {
        return "time: " + (Data_Show.show(Data_Show.showNumber)(v.value0) + (", iPassage: " + (Data_Show.show(Data_Show.showInt)(v.value1) + (", iEvent: " + Data_Show.show(Data_Show.showInt)(v.value2)))));
    }
};
export {
    fromPassageToCoord,
    Coord,
    coordenadaShowInstance
};
