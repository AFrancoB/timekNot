...
var launch = function __do() {
    Effect_Console.log("Unleash-Windsor: launch")();
    var ast = Effect_Ref["new"](new Unleash.Program(fromFoldable([ new Unleash.S(new Data_Tuple.Tuple("", 0), new Unleash.Q(0.0, 0.0)) ])))();
        ...
        return function (ws) {
            return function (we) {
                return function ($$eval) {
                    return fromFoldable1(Unleash.actualise(prog)(t)($$eval)(ws)(we));
                };
            };
        };
    };
...
var evaluate = function (unleash) {
    return function (str) {
        return function __do() {
            ...
            var pr = pErrorToString(Parsing.runParser(str)(Unleash.parseProgram));
