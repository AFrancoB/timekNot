...
var zoneToPrograms = function (z) {
    return function ($$eval) {
        return function (pr) {
            return function (prs) {
                return union(Data_Map_Internal.singleton(z)(new Data_Tuple.Tuple($$eval, pr)))(prs);
            };
        };
    };
};
...
var render = function (tk) {
    return function (args) {
        ...
        return function __do() {
            ...
            return map(Data_Array.concat)(traverse(function (pr) {
                return Voices.programToForeign(pr)(tp);
...
var launch = function (v) {
    return function __do() {
        ...
        var programs = Effect_Ref["new"](Data_Map_Internal.empty)();
    ...
    return function (args) {
        return function __do() {
            ...
            if (pr instanceof Data_Either.Right) {
                var newPrograms = zoneToPrograms(args.zone)($$eval)(pr.value0)(prs);
                Effect_Ref.write(newPrograms)(tk.programs)();
